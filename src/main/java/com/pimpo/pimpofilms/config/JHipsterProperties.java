...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pimpofilms@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pimpofilms API";

        private String description = "pimpofilms API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pimpofilms";
